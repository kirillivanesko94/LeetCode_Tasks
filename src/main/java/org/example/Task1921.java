...
public class Task1921 {
    public static void main(String[] args) {
        ...
        System.out.println(solution(dist1, speed1));
        System.out.println(solution(dist2, speed2));
        System.out.println(solution(dist3, speed3));
    }

    private static int solution(int[] dist, int[] speed) {
        if (dist.length != speed.length) {
            System.out.println("Неверное условие");
        }
        int result = 0;
